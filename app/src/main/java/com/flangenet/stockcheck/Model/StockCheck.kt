...
class StockCheck (var checkID: Int, var productId: Int, var displayOrder: Int, var description: String, var stock: Float, var oldStock:Float,var selected: Boolean) :
    Parcelable {
